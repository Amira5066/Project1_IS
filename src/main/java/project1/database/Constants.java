...
import static project1.database.Constants.Rights.BUY_BOOK;
import static project1.database.Constants.Rights.CREATE_BOOK;
import static project1.database.Constants.Rights.DELETE_BOOK;
import static project1.database.Constants.Rights.RETURN_BOOK;
import static project1.database.Constants.Rights.RIGHTS;
import static project1.database.Constants.Rights.SELL_BOOK;
import static project1.database.Constants.Rights.UPDATE_BOOK;
import static project1.database.Constants.Roles.ADMINISTRATOR;
...
public class Constants {
    ...
    public static class Tables {
        ...
        public static final String[] ORDERED_TABLES_FOR_CREATION = new String[]{USER, ROLE, RIGHT, ROLE_RIGHT, USER_ROLE,
                EMPLOYEE_REPORT, BOOK, PHYSICAL_BOOK, AUDIO_BOOK, EBOOK};
    }
